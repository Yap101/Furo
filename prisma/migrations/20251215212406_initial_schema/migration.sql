...
-- CreateIndex
CREATE INDEX "PurchasedApi_developerAddress_idx" ON "PurchasedApi"("developerAddress");

-- CreateIndex
CREATE INDEX "PurchasedApi_apiId_idx" ON "PurchasedApi"("apiId");

-- CreateIndex
CREATE INDEX "PurchasedApi_providerId_idx" ON "PurchasedApi"("providerId");

-- CreateIndex
CREATE INDEX "PurchasedApi_status_idx" ON "PurchasedApi"("status");

-- CreateIndex
CREATE INDEX "PurchasedApi_expiresAt_idx" ON "PurchasedApi"("expiresAt");

-- CreateIndex
CREATE INDEX "PurchasedApi_transactionHash_idx" ON "PurchasedApi"("transactionHash");
...
-- AddForeignKey
ALTER TABLE "PurchasedApi" ADD CONSTRAINT "PurchasedApi_providerId_fkey" FOREIGN KEY ("providerId") REFERENCES "Provider"("id") ON DELETE CASCADE ON UPDATE CASCADE;
